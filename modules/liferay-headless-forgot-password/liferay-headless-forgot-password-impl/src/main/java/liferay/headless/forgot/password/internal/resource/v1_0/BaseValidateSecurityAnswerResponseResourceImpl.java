...
public abstract class BaseValidateSecurityAnswerResponseResourceImpl
	implements ValidateSecurityAnswerResponseResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/liferay-headless-forgot-password/v1.0/validateSecurityAnswer' -d $'{"answer": ___, "email": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.Path("/validateSecurityAnswer")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public ValidateSecurityAnswerResponse postValidateSecurityAnswer(
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(
			BaseValidateSecurityAnswerResponseResourceImpl.class);
