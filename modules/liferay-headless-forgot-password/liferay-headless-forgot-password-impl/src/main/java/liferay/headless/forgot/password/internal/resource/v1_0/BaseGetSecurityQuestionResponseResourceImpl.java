...
public abstract class BaseGetSecurityQuestionResponseResourceImpl
	implements GetSecurityQuestionResponseResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/liferay-headless-forgot-password/v1.0/getSecurityQuestion' -d $'{"email": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.Path("/getSecurityQuestion")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public GetSecurityQuestionResponse postGetSecurityQuestion(
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(
			BaseGetSecurityQuestionResponseResourceImpl.class);
